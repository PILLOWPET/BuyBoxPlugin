...
2. Import routes
    ...
    sylius_paypal:
        resource: "@SyliusBuyboxPlugin/Resources/config/shop_routing.yaml"
        prefix: /{_locale}
        requirements:
    ...
    sylius_paypal_admin:
        resource: "@SyliusBuyboxPlugin/Resources/config/admin_routing.yml"
        prefix: /admin

    # config/routes.yaml

    sylius_paypal_webhook:
        resource: "@SyliusBuyboxPlugin/Resources/config/webhook_routing.yaml"
    ```
...
3. Import configuration
   ...
   imports:
       # ...
       - { resource: "@SyliusBuyboxPlugin/Resources/config/config.yaml" }
   ```
